...
def oiltruck():
    ...
    #robot.straight(400)
    gyro_straight(distance=320, speed=600, reset_angle=None, GCV=2.5,t_prime = 1 )
    # gyro_straight(distance=110, speed=100, reset_angle=None, GCV=2.5)
    robot.drive(speed=50, turn_rate=0) 
    time.sleep(0.9)
    robot.stop() 
    time.sleep(0.4)
    #goback
    gyro_straight(disance=400, speed=-500, reset_angle=None, GCV=2.5, t_prime = 1)
